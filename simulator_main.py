...
actorList = ActorList()
ret       = state.search(check.fish8011xxxxRotWrite, actorList, blockedRooms=[0x9], peekRooms=[0x9], blockedActors=[], forceMagic=False, indefinite=True)

# Print out the nodes in the heap before calling the success function
