...
def checkFishAddress(state):
    ...
    return addr == 0x801E8f90 or addr == 0x801f8f90 #1.2
...
state = GameState('OoT', 'OoT-N-1.2', {'lullaby':True, 'saria':True, 'bombchu':False, 'bomb':True, 'bottle':False, 'clearedRooms':[], 'beanPlanted':False, 'switchFlags':[0x1b, 0x8, 0xb, 0xc], 'collectibleFlags':[]})
